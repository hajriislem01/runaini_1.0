...
coach_dir = r"c:\Users\zied\Desktop\runaini_1.0-main\runaini_1.0-main\frontend\src\pages\coach"
shared_toaster_path = r"c:\Users\zied\Desktop\runaini_1.0-main\runaini_1.0-main\frontend\src\pages\administration\shared\AdminToaster.jsx"
shared_toaster_dir = os.path.dirname(shared_toaster_path)
...
def process_file(filepath):
    ...
    rel_dir = os.path.relpath(shared_toaster_dir, os.path.dirname(filepath)).replace("\\", "/")
    ...
    elif "import { Toaster, toast }" in content:
        content = content.replace("import { Toaster, toast } from 'react-hot-toast';", 
                                 f"import toast from 'react-hot-toast';\n{admin_toaster_import}")
    ...
    elif "import toast, { Toaster } from 'react-hot-toast'" in content:
        content = content.replace("import toast, { Toaster } from 'react-hot-toast'", 
                                 f"import toast from 'react-hot-toast';\n{admin_toaster_import}")
...
for root, dirs, files in os.walk(coach_dir):
    for file in files:
