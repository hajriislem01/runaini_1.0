...
import {
  ...
  FiShield, FiTrendingUp, FiX, FiUsers, FiAlertCircle,
} from 'react-icons/fi';
...
import {
  ...
  differenceInMinutes, differenceInHours, startOfWeek, addDays, isSameDay
} from 'date-fns';
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-500 flex-wrap">
                  ...
                  <span style={{ color: getCat(Array.isArray(nextSession.category) ? nextSession.category[0] : nextSession.category).color }}>
                    {getCat(Array.isArray(nextSession.category) ? nextSession.category[0] : nextSession.category).label}
                  </span>
                </div>
