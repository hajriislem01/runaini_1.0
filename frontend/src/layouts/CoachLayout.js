...
const CoachLayoutInner = () => {
  ...
  return (
              ...
              >
                ...
                >
                  ...
                  <div className="relative p-5 pb-6 border-b border-gray-800/60">
                    {/* Logo avatar - clickable to expand/collapse */}
                    <motion.div
    ...
    `}
              ...
              >
                ...
                {!isDesktopCollapsed && (
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 font-medium">Coach Panel</p>
                  </div>
                )}
              </div>
            </div>
      ...
      {/* Main Content */}
      <main className="md:ml-0 flex-1 flex flex-col h-screen overflow-hidden">
        {/* Top Header Bar */}
        <header className="h-16 flex items-center justify-between px-6 border-b border-gray-700/50 bg-black/20 backdrop-blur-md z-30">
          <div className="flex items-center gap-4">
            <h2 className="text-white font-bold hidden sm:block">Coach Space</h2>
          </div>
          <div className="flex items-center gap-4 pr-16 md:pr-0">
            ...
            <div className="items-center gap-3 hidden sm:flex">
               <div className="text-right">
                  ...
                  <p className="text-[10px] text-[#00d0cb]">Verified Coach</p>
               </div>
            </div>
          </div>
        </header>
