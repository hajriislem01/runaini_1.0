...
import {
  ...
  FiCreditCard, FiMail, FiTarget, FiLogOut, FiX, FiMenu, FiChevronRight, FiCheckSquare
} from 'react-icons/fi';
...
const navItems = [
  ...
  { to: '/administration/attendance-reports', icon: <FiCheckSquare />, key: 'attendance_reports' },
    ...
    <>
          ...
          <>
            ...
            >
              ...
              >
                  ...
                  >
                    ...
                    {!isMobileCollapsed && (
                      <div className="min-w-0 flex-1">
                        <h1 className="text-white text-lg font-bold truncate" title={organizationName}>{organizationName}</h1>
                ...
                {/* Logout */}
                <div className="mt-auto p-4 pb-6 border-t border-gray-800/60">
                  <motion.div
                    whileHover={{ x: isRtl ? -4 : 4 }}
                    transition={{ type: "spring", stiffness: 300 }}
                    className="relative"
                  >
                    <button
                      ...
                      className={`group flex items-center justify-between w-full rounded-xl border border-red-500/20 bg-red-500/10 transition-all duration-300
                        ${isMobileCollapsed ? 'justify-center p-3.5' : 'px-4 py-3.5 gap-4'}
      ...
      >
        ...
        >
          ...
          {/* Logout at bottom */}
          <div className={`p-4 pb-6 ${isDesktopCollapsed ? '' : 'border-t border-gray-800/60'}`}>
            <motion.div
              whileHover={{ x: isRtl ? -8 : 8 }}
              transition={{ type: "spring", stiffness: 300 }}
              className="relative"
            >
              <button
                onClick={handleLogout}
                className={`
                group flex items-center justify-between w-full rounded-xl border border-red-500/20 bg-red-500/10 transition-all duration-300
                ${isDesktopCollapsed ? 'justify-center p-3' : 'px-4 py-3 gap-4'}
                text-red-400 hover:text-red-300 hover:bg-red-500/20
              `}
