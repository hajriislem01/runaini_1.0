...
const PlayerSidebar = ({
  ...
  const { photoUrl, playerInitial, playerName } = usePlayer();
  const { t, i18n } = useTranslation('playersidebar');
            ...
            >
              ...
              >
                ...
                <div className="relative p-5 pb-6 border-b border-gray-800/60">
                  ...
                  >
                    {/* Player Image */}
                    <div className={`flex items-center justify-center flex-shrink-0 overflow-hidden rounded-full border-2 border-[#00d0cb] bg-gray-880 text-gray-400 font-bold ${isMobileCollapsed ? 'w-11 h-11 text-base' : 'w-10 h-10 text-sm'}`}>
                      {photoUrl ? (
                        <img
                          src={photoUrl}
                          alt="Player"
                    ...
                    {!isMobileCollapsed && (
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-300">{t('sidebar.teamMember')}</p>
                      </div>
                    )}
                  </motion.div>
                </div>
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          ...
                          ${isActive
                            ...
                            : 'text-gray-300 hover:text-white hover:bg-gray-800/40 hover:border-l-2 rtl:hover:border-l-0 rtl:hover:border-r-2 hover:border-[#902bd1]/50'
                          }`
                        }
                      >
